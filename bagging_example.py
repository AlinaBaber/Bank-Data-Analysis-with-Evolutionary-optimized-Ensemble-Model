...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test = train_test_split(BankingDataAnalysis.X, BankingDataAnalysis.y, test_size = 0.5, random_state = 50)
    ...
    # show the legend
    plt.legend()
    plt.title("Bagging ROC Curve Graph")
    plt.savefig('broc.png')
    # show the plot
    plt.show()
    ...
    print("\n================================================================================")
    print("\nGenerating estimators from Genetic Optimized Bagging method...")
    ...
    plt.xlim(-0.5, len(np.unique(y_test)) - 0.5)
    plt.ylim(len(np.unique(y_test)) - 0.5, -0.5)
    plt.savefig('bgconfusion.png')
    plt.show()


    val_initial_score = bagging.score(X_test, y_test)
    print(" Genetic Optimized Bagging Score : %f%%" % (val_initial_score))
    val_initial_score = np.asarray(val_initial_score)
    print("val_init", val_initial_score.shape)
    print("X_test:", X_test.shape)
    print("y_test:", y_test.shape)
    ...
    print("\n\n=======================================================================")
    print("Genetic Optimized Bagging Results")
    print("=======================================================================")
    ...
    # show the legend
    plt.legend()
    plt.title("Evolutionary Genetic Optimized Bagging ROC Curve Graph")
    plt.savefig('bgroc.png')
    # show the plot
    plt.show()


    individual_list = gen_opt.individual_list[-1]
    ...
    # show the legend
    plt.legend()
    plt.title("Voting Classifier ROC Curve Graph")
    plt.savefig('vroc.png')
    # show the plot
    plt.show()
    ...
    # show the legend
    plt.legend()
    plt.title("Gradient Boosting ROC Curve Graph")
    plt.savefig('gbroc.png')
    # show the plot
    plt.show()
    ...
    # show the legend
    plt.legend()
    plt.title("Cross Voting ROC Curve Graph")
    plt.savefig('cvconfusion.png')
    # show the plot
    plt.show()
    ...
    for i in range(len(y_test)):
        a = [pred1[i],pred2[i],pred3[i],vpredictions[i], predictions[i], cpredictions[i], hvpredictions[i],gpredictions[i],vpredictions[i], predictions[i], cpredictions[i], hvpredictions[i],gpredictions[i]]
        #print("Result Vector",a)
        retable.append(np.sum(a) / len(a))
    ...
    # show the legend
    plt.legend()
    plt.title("Hybrid ROC Curve Graph")
    plt.savefig('hbroc.png')
    # show the plot
    plt.show()
    ...
    # show the legend
    plt.legend()
    plt.title("Hybrid comparison with other models ROC Curve Graph")
